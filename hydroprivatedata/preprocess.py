...
LastEditTime: 2023-10-25 22:22:43
...
from hydroprivatedata.minio_api import boto3_upload_csv
...
def huanren_preprocess():
    ...
    try:
        ...
        boto3_upload_csv(minio_client, site_bucket, site_object, local_save_path)
